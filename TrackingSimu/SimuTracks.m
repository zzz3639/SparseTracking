function [Movies, Trj] = SimuTracks(Smol,S,AC,SV,I0,DI0,alpha,Dmu,Rho,Pic0,Tmax,Nrepeat,Mrepeat,no,sigma,obnoise)
%Modified in 2017.10.30 by ZHANG Haowen
%Usage: [Movies] = SimuTracks(Smol,S,AC,SV,I0,DI0,alpha,Dmu,Rho,Pic0,Tmax,Nrepeat,Mrepeat,no,sigma,obnoise)
...
% outputs:
%  Movies: cell matrix of Nrepeat*Mrepeat, entry i,j is a movie that do Silicon imaging based on Trj{i}
%  Trj: cell array of lenth Nrepeat, Nrepeat simulations of molecule motion using the same parameter
