function [Movies, Trj] = SimuTracksDeceleratePoisson(Smol,S,AC,SV,I0,DI0,alpha,Dmu,Rho,Pic0,Tmax,Nrepeat,Mrepeat,no,sigma,obnoise)
...
Rho = Rho/sum(sum(Rho));
Trj = SiliconMovementDecelerate(AC,SV,I0,DI0,alpha,Dmu,Smol(1:2),Rho,Pic0,Tmax,Nrepeat);
for i=1:Nrepeat
    trjthis = Trj{i};
