function [Movies, Trj] = SimuTracksConfinedPoisson(Smol,S,AC,SV,I0,DI0,alpha,Dmu,Centerinfo,Rho,Pic0,Tmax,Nrepeat,Mrepeat,no,sigma,obnoise)
%Modified in 2018.12.08 by ZHANG Haowen
...
Rho = Rho/sum(sum(Rho));
Trj = SiliconMovementConfined(AC,SV,I0,DI0,alpha,Dmu,Centerinfo,Smol(1:2),Rho,Pic0,Tmax,Nrepeat);
for i=1:Nrepeat
    trjthis = Trj{i};
