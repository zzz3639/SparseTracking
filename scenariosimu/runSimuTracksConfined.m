...
[Movies, Trj] = SimuTracksConfined(Smol, S, N/svl, svl-1, Imean, Dint, alpha, Dmu, Centerinfo, ones(Smol(1),Smol(2)), zeros(0,3), Nframes, 1, 1, no*S(1)*S(2), sig, 0);
...
[Movies, Trj] = SimuTracksConfined(Smol, S, N/svl, svl-1, Imean, Dint, alpha, Dmu, Centerinfo, ones(Smol(1),Smol(2)), zeros(0,3), Nframestunning, 1, 1, no*S(1)*S(2), sig, 0);
