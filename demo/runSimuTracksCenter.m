...
svl = 20;
zoom = 10;
Nframes = 1000; % Nframes frames are simulated, only the last Tmax frames are preserved
Tmax = 500;
Dmu = 0.0;
center = [Smol(1)/2-0.5,Smol(2)/2-0.5];
Centerinfo = [center,0.1];
[Movies, Trj] = SimuTracksCenter(Smol, S, N/svl, svl-1, 1000, 0.5, 0.7, Dmu, Centerinfo, ones(Smol(1),Smol(2)), zeros(0,3), Nframes, 1, 1, 50*S(1)*S(2), 1, 0);
