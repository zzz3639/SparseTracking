...
screen -dmS ${jobname}all ${matlab} -nodesktop -singleCompThread -r "load ${foldername}.mat;[ trjans, trjansdetail ] = runSparseTrackingTunningAllmultiK(moviethis, movietunning, trjtruetunning, ${psfwidth}, ${psfdecay}, ${boundarysize}, ${thint}, ${corenum}, 'all${jobname}', ${multinum}); save('resfix${jobname}.mat'); exit;"
